            ...
            <div className='left'>
              ...
              <div className='contLeft'>
                ...
                <div className='centerLeft2'>
                  Task It es una plataforma que te permite comprobar si estás realizando tus trabajos de manera correcta y siguiendo todas las reglas gramaticales y fonéticas de la lengua extranjera en cuestión. 
                </div>
