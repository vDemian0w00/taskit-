      ...
      <div className="conteinerIndex">
        <header className="header">
          ...
          <div className="otherEle">
            <div className="li1">
              <button onClick={handleOpen1} className="Nosotros">
                Nosotros
              </button>
              <Modal
                  ...
                  <Box sx={style1}>
                    ...
                    <Typography id="transition-modal-description1">
                      <div className="secondText1">
                        Somos una empresa llamada "Euclid Tech" conformada por
                        estudiantes de nivel medio superior la cual busca
                        desarrollar software para resolver problemáticas que se
                        presenten en diferentes sectores en la actualidad. A
                        continuación te presentamos un pequeño organigrama para
                        que puedas conocer a nuestro equipo.
                      </div>
                    </Typography>
                  </Box>
                </Fade>
            ...
            <div className="li2">
              <button onClick={handleOpen2} className="Objetivo">
                Objetivo
              </button>
              <Modal
                ...
                <Fade in={open2}>
                  <Box sx={style2}>
                    ...
                    <Typography id="transition-modal-description2">
                      <div className="secondText1">
                        Misión: Crear software a escala global que resuelva los
                        problemas que afectan al mundo en el que vivimos, para
                        personas de todas las edades.
                      </div>
                      <div className="secondText2">
                        Visión: Nos vemos en 5 años en el top de empresas de
                        desarrollo software, manteniendo los altos estándares de
                        calidad, así como los valores que Euclid Tech tendrá
                        siempre en cuenta.
                      </div>
                    </Typography>
                  </Box>
            ...
            <div className="li3">
              <button onClick={handleOpen3} className="Contacto">
                Contáctanos
              </button>
              <Modal
                    ...
                    <Typography id="transition-modal-description3">
                      <div className="iconsSocial">
                        <div className="iconsS">
                          <Link
                            to={"https://www.instagram.com/euclid_tech9/"}
                            target="_blank"
                          ...
                          <Link
                            to={
                              "https://www.facebook.com/profile.php?id=100090799624819"
                            }
                            target="_blank"
                            className="socialButtons"
                          >
        ...
        <div className="conteinerBoth">
          <div className="left">
            <div className="contLeft">
              ...
              <div className="centerLeft2">
                Task It! Es una plataforma que te permite comprobar si estás
                realizando tus trabajos de manera correcta relacionados con
                algún idioma o, que sean hechos por expertos en el tema,
                siguiendo todas las reglas gramaticales y fonéticas de la lengua
                elegida.
              </div>
            </div>
          </div>
          ...
          <div className="right">
            <div className="contImage">
              <svg
                fill="rgb(236, 248, 255)"
                viewBox="0 0 200 200"
                xmlns="http://www.w3.org/2000/svg"
                className="blob"
              >
                <path
                  d="M48.2,-75.7C60.4,-67.1,66.8,-50.3,73.3,-34C79.9,-17.8,86.5,-2.2,86.8,14.2C87.1,30.6,81,47.7,70,61C59,74.3,43.2,83.7,26.3,87.8C9.4,92,-8.5,90.9,-22.8,83.8C-37.2,76.8,-47.9,63.9,-59.9,51.2C-71.9,38.6,-85.1,26.4,-88.2,12.1C-91.2,-2.3,-84.1,-18.7,-76.2,-34.3C-68.3,-49.8,-59.6,-64.5,-46.8,-72.9C-33.9,-81.2,-17,-83.2,0.5,-84C18,-84.8,36,-84.4,48.2,-75.7Z"
